        ...
        <div className="md:hidden w-full mb-4">
            <Sheet>
                ...
                <SheetContent side="left" className="overflow-y-auto w-[300px]">
                    <SheetTitle className="sr-only">Course Filters</SheetTitle>
                    <SheetTrigger className="absolute right-4 top-4" /> {/* Handle focus trap issue if needed or rely on default close */}
                    <div className="mt-6">
                        <FilterMenu />
                    </div>
                </SheetContent>
                ...
                >
                  <CardContent className="flex gap-4 p-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[16px] text-gray-600 mt-3 mb-2 dark:text-gray-400">
